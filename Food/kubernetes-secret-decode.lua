...
local org = "ashleyschuett"
local repo = "kubernetes-secret-decode"
...
food = {
    ...
    packages = {
        ...
        },
        {
            os = "darwin",
            arch = "386",
            url = base_url .. "/releases/download/v" .. version .. "/" .. name .. "_" .. version .. "_Darwin_i386.tar.gz",
        ...
        },
        {
            os = "linux",
            arch = "386",
            url = base_url .. "/releases/download/v" .. version .. "/" .. name .. "_" .. version .. "_Linux_i386.tar.gz",
