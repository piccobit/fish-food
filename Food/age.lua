    ...
    packages = {
        {
            os = "darwin",
            arch = "amd64",
            url = "https://github.com/" .. org .. "/" .. repo .. "/releases/download/v" .. version .. "/" .. name .. "-v" .. version .. "-darwin-amd64.tar.gz",
        ...
        },
        {
            os = "darwin",
            arch = "arm64",
            url = "https://github.com/" org .. "/" .. repo .. "/releases/download/v" .. version .. "/" .. name .. "-v" .. version .. "-darwin-arm64.tar.gz",
            -- shasum of the release archive
        ...
        },
        {
            os = "linux",
            arch = "amd64",
            url = "https://github.com/" org .. "/" .. repo .. "/releases/download/v" .. version .. "/" .. name .. "-v" .. version .. "-linux-amd64.tar.gz",
            -- shasum of the release archive
        ...
        },
        {
            os = "linux",
            arch = "arm",
            url = "https://github.com/" org .. "/" .. repo .. "/releases/download/v" .. version .. "/" .. name .. "-v" .. version .. "-linux-arm.tar.gz",
            -- shasum of the release archive
        ...
        },
        {
            os = "linux",
            arch = "arm64",
            url = "https://github.com/" org .. "/" .. repo .. "/releases/download/v" .. version .. "/" .. name .. "-v" .. version .. "-linux-arm64.tar.gz",
            -- shasum of the release archive
        ...
        },
        {
            os = "windows",
            arch = "amd64",
            url = "https://github.com/" org .. "/" .. repo .. "/releases/download/v" .. version .. "/" .. name .. "-v" .. version .. "-windows-amd64.zip",
            -- shasum of the release archive
